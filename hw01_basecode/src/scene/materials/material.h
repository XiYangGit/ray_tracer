...
public:
    ...
    virtual glm::vec3 EvaluateReflectedEnergy(const Intersection &isx, const glm::vec3 &outgoing_ray, const glm::vec3 &incoming_ray, const glm::vec3 &viewing_ray,  Integrator const * const integrator,unsigned int dep,const glm::vec2 &uv) const = 0;
